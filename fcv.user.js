...
// @version      42.0
// @description  Foresight Plus: Foresight lane visualizer with auto Recirc sorting, AWSUI-only Top Recirc harvesting, compact allocations, Grafana lane names, and creator mark.
// @author       janazare
...
(function () {
    ...
    const BUILD = {
        ...
        version: "42.0",
        author: "janazare",
        signature: "FORESIGHT-PLUS-JANAZARE-42"
    };
...
`);
    ...
    function renderControlBar() {
        ...
        updateToolbarOffset();
        cleanFloatingForesightStickyElements();
    ...
    function ensureCreatorSignature() {
        ...
        if (!signature) {
            ...
            signature.textContent = "Foresight Plus v42 • @janazare";
...
`);
    ...
    GM_addStyle(`
/* Foresight Plus v42 version label + watermark */
